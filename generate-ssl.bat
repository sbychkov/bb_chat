...
REM This script creates certificates for localhost
...
openssl req -new -x509 -key ssl\key.pem -out ssl\cert.pem -days 365 -subj "/C=US/ST=Development/L=Local/O=Band of Blades/CN=localhost"
